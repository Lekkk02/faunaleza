    ...
    <>
      ...
      <div className="flex justify-between overflow-hidden">
        <div className="flex flex-col items-center justify-center min-h-[100vh] w-[25vw] min-w-[25vw] max-w-[25vw]">
          <div className="flex flex-col flex-1 w-full items-center justify-center relative right-[-60px] max-h-[50vh] ">
            <img
              src={"/manati/descripcion/btnComosoy.png"}
              className={`relative h-[7vh] min-h-[7vh] w-[20vw] min-w-[20vw] z-10 transition-all duration-500 ease-in-out hover:scale-[1.1] ${
                showComoSoy
            ...
            <div className={`${showComoSoy ? "flex" : "h-0 w-0"}`}>
              <img
                src={"/manati/descripcion/clic_como_soy.png"}
                className={`h-[35vh] min-h-[35vh] w-[20vw] min-w-[20vw] transition-all duration-500  z-[5] ${
                  showComoSoy
          ...
          <div className="flex flex-col flex-1 w-full items-end justify-start relative max-h-[50vh]  ">
            <img
              src="/manati/descripcion/btnCorazon.png"
              className={` transition-transform duration-500 ease-in-out hover:scale-[1.2]  ${
                showHeart
                  ? "opacity-0  w-[8vw] min-w-[8vw] h-[13vh] min-h-[13vh]  "
            ...
            <img
              src="/manati/descripcion/globotexto.png"
              className={` w-[20vw] min-w-[20vw] h-[20vh] min-h-[20vh] transition-all duration-500 ease-in relative   ${
                showHeart ? "opacity-100 " : "opacity-0 "
              }`}
            />
            <Image
              className={` transition-all duration-500 ease-in-out relative opacity-100 w-[20vw] min-w-[20vw] h-[20vh] min-h-[20vh]"}`}
              src={"/manati/descripcion/Manati.gif"}
              height={10}
              width={10}
            />
          </div>
        ...
        <div className="overflow-x-visible flex flex-col justify-between  items-center  h-[100vh] pt-12 w-[50vw] min-w-[50vw] max-w-[50vw]">
          <div className="flex">
            <img
              src={"/manati/descripcion/titulo.png"}
              className="w-auto h-[80px] mt-[10px] relative "
            />
          </div>
          <div className="flex flex-col justify-center items-center">
            <Image
              className="relative w-[16vw] min-w-[16vw] h-[20vh] top-[10px] min-h-[20vh]"
              src={"/manati/descripcion/manati_centro.gif"}
              height={50}
              width={50}
            />
            <img
              src={"/manati/descripcion/quiensoy.png"}
              className="w-[20vw]  min-w-[20vw] h-[7vh] min-h-[7vh] relative  "
            />
            <div className="w-[35vw]  min-w-[35vw] h-[35vh] min-h-[35vh] border-[5px] border-[#ec6255] rounded-3xl relative overflow-hidden">
              <video
                controls
        ...
        <div className="flex flex-col items-center justify-stretch min-h-[100vh] w-[25vw] min-w-[25vw] max-w-[25vw]">
          <div className="flex flex-col items-center justify-center max-h-[100vh]">
            <div className="flex flex-1 flex-col items-center justify-center  min-h-[50vh]">
              <img
                src={"/manati/descripcion/btnAlimentacion.png"}
                className={`relative h-[7vh] min-h-[7vh] w-[20vw] min-w-[20vw]   z-10 transition-all duration-500 ease-in-out hover:scale-[1.1] ${
                  showAlimentacion
                    ? "opacity-100 "
                    : "opacity-100 hover:cursor-pointer"
              ...
              <div className="flex flex-col">
                <Image
                  src={"/manati/descripcion/grafico.gif"}
            ...
            >
              <img
                src={"/manati/descripcion/btnTetero.png"}
              ...
              >
                <Image
                  className="w-[25vw] min-w-[25vw] h-[35vh] min-h-[35vh] relative right-[40px]"
                  src={"/manati/descripcion/barras.gif"}
                  height={320}
                  width={200}
                />
              </div>
